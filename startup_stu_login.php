    ...
    else
    {
        ...
        else
        {
            ...
            if(strcmp($pass, $row['PASSWORD'])==0)
            {
                ...
                echo "<script>window.location=\"studentacc.php\";</script>";
            }
            else
            {
                echo "<script>alert('WRONG PASSWORD');window.location=\"startup_stu_login.php\";</script>";
            }
        }
    }
}
...
<body>
    <h1 align="CENTER">LOGIN FOR NORMAL STUDENTS</h1>
<center><form method="post" action="startup_stu_login.php">
    <table>
