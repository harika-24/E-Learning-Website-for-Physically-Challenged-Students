...
<table>
	...
	<tr><th>COURSE CODE</th><th>COURSE NAME</th><th>UPLOAD</th></tr>
	<?php
	...
	while($row=mysqli_fetch_assoc($result))
	{
		...
		echo "<tr><td>".$code."</td><td>".$row1['COURSENAME']."</td><td><button><a href=\"finalupload.php?a=".$code."\">UPLOAD</a></button></td></tr>";
	}
	?>
</table>
</body>
